...
class Locataire extends Component {
  constructor(props) {
    super(props);
    this.state = {
      id: "",
            ...
            <Space size={1}>
                ...
                onClick={async () => {
                  try {
                    let result = await this.contract.methods
                      .LocataireManage(record.id1, "Desactivee")
              ...
              <Button
                ...
                onClick={async () => {
                  try {
                    let result = await this.contract.methods
                      .LocataireManage(record.id1, "Active")
                      .send({ from: this.accounts[0] });
                    if (result.status === true) {
                      this.Locataireliste();
          ...
          >
            ...
            >
              <Space size={3}>
                <Button
                  type="Success"
                  onClick={this.ajouterLocataire.bind(this)}
                >
                  Envoyer
                </Button>
